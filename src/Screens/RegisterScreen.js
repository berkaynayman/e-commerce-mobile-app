            ...
            >
                <VStack space="4" w="60%">
                    ...
                    <Button
                        ...
                        bg={Colors.main}
                    >
                        <Text fontSize="16" fontWeight="bold" color={Colors.white} onPress={() => navigation.navigate("Bottom")}>
                            SIGN UP
                        </Text>
                    </Button>
                    <Pressable>
                        <Text color={Colors.deepestGray} fontWeight="bold" onPress={() => navigation.navigate("Login")}>
                            LOGIN
                        </Text>
                    </Pressable>
                </VStack>
